...
Experiment 5 closed the original heterogeneous-fleet contribution: 4/5 best single coverage, 20% strict serviceability loss, minimum two-element strict coverage and unique family-level cellular+LoRaWAN portfolio. The five-experiment programme was therefore frozen and split into two manuscript scopes: benchmark/data and methodology/results.
